...
async function setup() {
  ...
  const properties = [
    {
      ...
      description: {
        fr: "Magnifique villa moderne de 4 chambres située dans un quartier sécurisé de Boy-Rabe, à 10 min du centre-ville. La maison comprend un grand salon-séjour ouvert sur la cuisine équipée, une suite parentale avec dressing et salle de bain privative, ainsi qu'un beau jardin avec piscine. Idéale pour une famille ou des expatriés. Disponible immédiatement.",
        en: "Stunning modern 4-bedroom villa in a secure Boy-Rabe neighbourhood, 10 minutes from downtown. Features open-plan living with fitted kitchen, master suite with walk-in closet, and a beautiful garden with pool. Ideal for a family or expatriates. Available immediately.",
      },
    ...
    },
    {
      ...
      description: {
        fr: "Appartement F3 lumineux au 2ème étage d'un immeuble résidentiel calme à Lakouanga. 2 chambres, salon spacieux, cuisine séparée, balcon avec vue sur le quartier. Eau courante, électricité stable, parking sécurisé. Parfait pour un couple ou un jeune professionnel.",
        en: "Bright 2-bedroom apartment on the 2nd floor of a quiet residential building in Lakouanga. Spacious living room, separate kitchen, balcony with neighbourhood view. Running water, stable electricity, secure parking. Perfect for a couple or young professional.",
      },
    ...
    },
    {
      ...
      description: {
        fr: "Grande maison familiale dans le quartier résidentiel de Sica 2. 5 chambres, 4 salles de bain, grand salon, jardin clôturé, groupe électrogène inclus. Idéale pour une grande famille ou une entreprise souhaitant loger ses expatriés.",
        en: "Large family house in the residential Sica 2 neighbourhood. 5 bedrooms, 4 bathrooms, large living room, fenced garden, generator included. Ideal for a large family or a company housing expatriates.",
      },
    ...
    },
    {
      ...
      description: {
        fr: "Parcelle titrée de 800 m² située à Galabadja, dans un secteur en plein développement. Terrain plat, viabilisé (eau et électricité à proximité immédiate), idéal pour la construction d'une maison familiale ou d'un petit immeuble. Titre foncier disponible. À 15 min du marché central.",
        en: "Titled 800 m² plot in Galabadja, in a fast-developing sector. Flat land, serviced (water and electricity nearby), ideal for building a family home or small building. Title deed available. 15 minutes from the central market.",
      },
    ...
    },
    {
      ...
      description: {
        fr: "Somptueuse villa de standing de 5 chambres avec piscine à Sica 1. Finitions de qualité, cuisine américaine ouverte, grand salon, salle de sport. Résidence sécurisée 24h/24.",
        en: "Luxurious 5-bedroom villa with pool in Sica 1. Quality finishes, open-plan kitchen, large living room, gym. 24/7 secured residence.",
      },
      intent: 'rent', type: 'villa', status: 'available',
    ...
    },
    {
      ...
      description: {
        fr: "Studio entièrement meublé en plein centre de Bangui. Idéal pour un professionnel ou un étudiant. Tout équipé : literie de qualité, cuisine fonctionnelle, climatisation. Accès sécurisé.",
        en: "Fully furnished studio in central Bangui. Ideal for a professional or student. Fully equipped: quality bedding, functional kitchen, air conditioning. Secured access.",
      },
    ...
    },
    {
      ...
      description: {
        fr: "Belle maison de 3 chambres avec un grand jardin clôturé au quartier Combattant. Idéale pour une petite famille. Groupe électrogène, réservoir d'eau, parking pour 2 véhicules.",
        en: "Beautiful 3-bedroom house with a large fenced garden in Combattant. Ideal for a small family. Generator, water tank, parking for 2 vehicles.",
      },
    ...
    },
    {
      ...
      description: {
        fr: "Appartement F2 lumineux dans une résidence calme de Galabadja. 1 chambre, salon, cuisine, balcon. Eau et électricité stables. Parfait pour un professionnel seul.",
        en: "Bright F2 apartment in a quiet Galabadja residence. 1 bedroom, living room, kitchen, balcony. Stable water and electricity. Perfect for a single professional.",
      },
      intent: 'rent', type: 'apartment', status: 'available',
  ...
  await db.leads.insertAsync({
    ...
    subject: 'Je cherche à louer', message: 'Bonjour, je suis intéressée par la villa de Boy-Rabe. Pouvez-vous me donner plus d\'informations?',
    channel: 'form', notes: '',
  });
